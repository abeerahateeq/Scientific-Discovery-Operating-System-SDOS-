          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <button
                ...
                disabled={loading}
                className="w-full py-2.5 px-4 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white rounded-xl text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm"
              >
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-2.5 px-4 bg-sky-950/40 hover:bg-sky-950/70 border border-sky-500/30 text-sky-300 rounded-xl text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
                <Globe className="w-4 h-4 text-sky-400" />
                Quick Guest Scholar Login
              </button>
            </div>
