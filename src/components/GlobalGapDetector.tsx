...
const DISCIPLINES = [
  { name: "Materials Science", volume: 10, fillChar: "█", fillPercent: 100 },
...
const INTERSECTION_DATA: Record<string, Record<string, {
  ...
  "Materials Science": {
    "Materials Science": { gapScore: 10, papersCount: 14500, saliency: 25, proposedQuery: "", shortDesc: "Highly explored standard crystal lattice pathways", proposedHypothesisTitle: "" },
    "Climate Change": { gapScore: 45, papersCount: 124, saliency: 62, proposedQuery: "Analyze carbon capture thermal degradation bounds in nanostructured MOF materials under hyper-variable climate conditions.", shortDesc: "Thermal models applied to MOF carbon capture efficiency", proposedHypothesisTitle: "Macro-climatic Thermal Bounds for Metal-Organic Framework Sequestration" },
    "Quantum Computing": { gapScore: 82, papersCount: 12, saliency: 92, proposedQuery: "Implement quantum topological syndrome decoders on multi-spectral crystalline lattice defects.", shortDesc: "Quantum error correction algorithms mapping topological lattice defects", proposedHypothesisTitle: "Fault-Tolerant Topological Syndrome Decoding for Superconducting Materials" },
    "Marine Biology": { gapScore: 89, papersCount: 4, saliency: 95, proposedQuery: "Synthesize corrosion-resistant bio-inspired alloys using deep-sea benthic organism metabolomics.", shortDesc: "Deep-sea biological surface scaffolds guiding anti-fouling materials", proposedHypothesisTitle: "Benthic Biological Matrix Scaffolding for Anti-Corrosive Metallurgy" },
    "Synthetic Ecology": { gapScore: 94, papersCount: 1, saliency: 98, proposedQuery: "Model material degradation in synthetic ecological niches utilizing multi-agent carrying capacity simulations.", shortDesc: "Multi-agent ecological predator-prey dynamics inside material degradation zones", proposedHypothesisTitle: "Ecological Carrying Capacity Modeling for Biodegradable Polymers" }
  },
  "Climate Change": {
    "Materials Science": { gapScore: 45, papersCount: 124, saliency: 62, proposedQuery: "Analyze carbon capture thermal degradation bounds in nanostructured MOF materials under hyper-variable climate conditions.", shortDesc: "Thermal models applied to MOF carbon capture efficiency", proposedHypothesisTitle: "Macro-climatic Thermal Bounds for Metal-Organic Framework Sequestration" },
  ...
  "Quantum Computing": {
    "Materials Science": { gapScore: 82, papersCount: 12, saliency: 92, proposedQuery: "Implement quantum topological syndrome decoders on multi-spectral crystalline lattice defects.", shortDesc: "Quantum error correction algorithms mapping topological lattice defects", proposedHypothesisTitle: "Fault-Tolerant Topological Syndrome Decoding for Superconducting Materials" },
  ...
  "Marine Biology": {
    "Materials Science": { gapScore: 89, papersCount: 4, saliency: 95, proposedQuery: "Synthesize corrosion-resistant bio-inspired alloys using deep-sea benthic organism metabolomics.", shortDesc: "Deep-sea biological surface scaffolds guiding anti-fouling materials", proposedHypothesisTitle: "Benthic Biological Matrix Scaffolding for Anti-Corrosive Metallurgy" },
  ...
  "Synthetic Ecology": {
    "Materials Science": { gapScore: 94, papersCount: 1, saliency: 98, proposedQuery: "Model material degradation in synthetic ecological niches utilizing multi-agent carrying capacity simulations.", shortDesc: "Multi-agent ecological predator-prey dynamics inside material degradation zones", proposedHypothesisTitle: "Ecological Carrying Capacity Modeling for Biodegradable Polymers" },
